...
def Inception_Inflated3d(include_top=True,
    ...
    if include_top:
        ...
        #x = conv3d_bn(x, 512, 1, 1, 1, padding="same", use_bias=True, use_activation_fn=False, use_bn=True, name="conv3d_6b_1x1")
    ...
    #model = add_lstm_layers(model, 35)
    # load weights
...
def add_lstm_layers(base_model, classes, dropout = 0.5):
    ...
    new_model = Model(inputs = base_model.input, output = predictions, name = "i3d_with_LSTM_top")
